        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 sm:gap-8 mb-16">
          ...
          <div className="md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex items-center gap-4">
              <a href="#" target='_blank' className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-[#EE4B15]/20 hover:text-[#EE4B15] hover:border-[#EE4B15]/50 hover:-translate-y-1 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:shadow-[0_0_20px_rgba(238,75,21,0.4)]">
