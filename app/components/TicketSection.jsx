...
export default function TicketSection() {
  ...
  return (
    <div id="ticket" className="max-w-6xl mx-auto w-full mt-4 sm:mt-8 mb-20 text-center flex flex-col items-center px-4 relative z-10">
        ...
        <div className="w-full md:w-[320px] flex-shrink-0 z-10 flex flex-col justify-stretch">
          <div className="w-full h-full bg-[#F8FAFC]/95 border border-white/50 rounded-[24px] p-5 md:p-6 flex flex-col justify-between shadow-[0_8px_30px_rgba(0,0,0,0.04)] text-center relative overflow-hidden">
            ...
            <div className="w-full">
              ...
              }} className="flex items-center justify-between w-full px-5 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all shadow-[0_8px_20px_rgba(16,185,129,0.15)] cursor-pointer select-none border border-emerald-400/20">
